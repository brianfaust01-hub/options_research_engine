...
def _evaluate_recommendation(
    ...
    result = {
        ...
        "ShadowExitPolicyVersion": row.get("shadow_exit_policy_version"),
        "ShadowExitPolicyStatus": row.get("shadow_exit_policy_status"),
        "ShadowExitSampleSize": _safe_float(row.get("shadow_exit_sample_size")),
        "ShadowExitMatchLevel": row.get("shadow_exit_match_level"),
        "ShadowStopLossPct": _safe_float(row.get("shadow_stop_loss_pct")),
        "ShadowProfitTargetPct": _safe_float(row.get("shadow_profit_target_pct")),
        "ShadowStopLossPrice": _safe_float(row.get("shadow_stop_loss_price")),
        "ShadowProfitTargetPrice": _safe_float(row.get("shadow_profit_target_price")),
        "ShadowExpectedReturnPct": _safe_float(row.get("shadow_expected_return_pct")),
        "ShadowTargetFirstRate": _safe_float(row.get("shadow_target_first_rate")),
        "ShadowStopFirstRate": _safe_float(row.get("shadow_stop_first_rate")),
        "ShadowTimeExitRate": _safe_float(row.get("shadow_time_exit_rate")),
